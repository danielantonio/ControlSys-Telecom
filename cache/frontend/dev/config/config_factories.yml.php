...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/controle_sys/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/controle_sys/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/controle_sys/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/controle_sys/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/controle_sys/apps/frontend/template',
)));
